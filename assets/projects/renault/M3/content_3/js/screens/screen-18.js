function screen40(app, data, components) {
    ...
    interaction.on(interaction.events.END, async () => {
        storedDatas["content-3-question-2"] = interaction.success;
