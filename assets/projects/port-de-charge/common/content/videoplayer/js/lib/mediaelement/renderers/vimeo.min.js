  ...
  1: [function (e, t, n) {
    ...
    var r = {
      ...
      load: function load(e) {
        "undefined" != typeof Vimeo ? r._createPlayer(e) : (r.promise = r.promise || mejs.Utils.loadScript("https://player.vimeo.com/api/player.js"), r.promise.then(function () {
          r._createPlayer(e);
        }));
      },
      ...
      getVimeoId: function getVimeoId(e) {
        return void 0 === e || null === e ? null : (e = e.split("?")[0], parseInt(e.substring(e.lastIndexOf("/") + 1), 10));
      }
    },
        i = {
      name: "vimeo_iframe",
      ...
      create: function create(e, t, n) {
        ...
        }, h = mejs.html5media.properties, y = 0, g = h.length; y < g; y++) {
          !function (t) {
            ...
            a["get" + n] = function () {
              if (null !== p) {
                switch (t) {
                  ...
                  case "src":
                    return p.getVideoUrl().then(function (e) {
                      m = e;
                    }).catch(function (e) {
                      return v(e);
                    }), m;
              ...
              if (null !== p) switch (t) {
                ...
                case "currentTime":
                  p.setCurrentTime(n).then(function () {
                ...
                case "volume":
                  p.setVolume(n).then(function () {
                    u = s = n, setTimeout(function () {
        ...
        window["__ready__" + a.id] = function (t) {
          if (e.vimeoPlayer = p = t, i.length) for (var n = 0, r = i.length; n < r; n++) {
            var u = i[n];
          ...
          for (var y = document.getElementById(a.id), g = void 0, E = 0, U = (g = ["mouseover", "mouseout"]).length; E < U; E++) {
            y.addEventListener(g[E], function (t) {
          ...
          for (var b = 0, j = (g = ["rendererready", "loadedmetadata", "loadeddata", "canplay"]).length; b < j; b++) {
        ...
        return x && e.originalNode.autoplay && -1 === x.indexOf("autoplay") && (x += "&autoplay=1"), x && e.originalNode.loop && -1 === x.indexOf("loop") && (x += "&loop=1"), N.setAttribute("id", a.id), N.setAttribute("width", w), N.setAttribute("height", j), N.setAttribute("frameBorder", "0"), N.setAttribute("src", "" + _ + x), N.setAttribute("webkitallowfullscreen", "true"), N.setAttribute("mozallowfullscreen", "true"), N.setAttribute("allowfullscreen", "true"), e.originalNode.parentNode.insertBefore(N, e.originalNode), e.originalNode.style.display = "none", r.load({
          iframe: N,
          id: a.id
        }), a.hide = function () {
