...
// utilise les transitions CSS pour les transitions entre les slides
...
function Slider(props){
    ...
    this.onEach = typeof props.onEach == "function" ? props.onEach : function(){};
    this.onEachEnd = typeof props.onEachEnd == "function" ? props.onEachEnd : function(){};
...
Slider.prototype = {
    ...
    addEvents: function(){
        ...
        for(var t=1; t<=this.slides.length; t++){
            var slide = this.slides[t-1];
            slide.addEventListener("transitionend",this.handleTransitionEnd);
            slide.addEventListener("webkitTransitionEnd",this.handleTransitionEnd);
        }
    },
    removeEvents: function(){
        ...
        for(var t=1; t<=this.slides.length; t++){
            ...
            slide.removeEventListener("webkitTransitionEnd",this.handleTransitionEnd);
        }
    }
};