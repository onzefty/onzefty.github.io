var Utility = (function () {
    ...
    return {
        ...
        */
        ...
        createSocket: function (env, token, query) {
            return new Promise(function (resolve, reject) {
                ...
                socket.on('connect', function () {
                    // console.log('Socket IO connected :: socket:', socket);
                    resolve(socket);
                });
                ...
                socket.on('connect_error', (error) => {
                    console.error('Socket IO connection failed :: error :', error);
                    reject(error);
                });
            });
        },
        ...
        removeSocketListeners(socket) {
            if (socket) {
                Object.keys(socket._callbacks)
                    ...
                    .filter((eventName) => !(/^(dis)?connect(_error)?$/gi.test(eventName)))
                    .forEach((eventName) => {
