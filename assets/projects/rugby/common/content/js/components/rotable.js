...
Rotable.prototype = {
    ...
    onMove: function (e) {
        ...
        if (parseInt(d % this.every) == 0 && this.isActive==true) {
            ...
            if (this.angleMin != null && d < this.angleMin && !resetCondition && this.angleMin != 0) {
                this.angleCurrent = this.angleMin;
                this.setAngle(this.angleMin);
            }
            if (this.angleMax != null && d > this.angleMax && !resetCondition && this.angleMax != 360) {
    ...
    setAngle: function (angle) {
        this.triggeringElement.style["transform"] = "rotate(" + (angle) + "deg)";
        this.triggeringElement.style["-moz-transform"] = "rotate(" + (angle) + "deg)";
        this.triggeringElement.style["-webkit-transform"] = "rotate(" + (angle) + "deg)";
        this.triggeringElement.style["-o-transform"] = "rotate(" + (angle) + "deg)";
    },
